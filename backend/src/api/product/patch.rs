...
use actix_web::{web::{Json, Path}, patch, HttpResponse, Responder};
use serde::{Serialize, Deserialize};
use mysql::{prelude::Queryable, params, Error, DriverError, Statement, PooledConn};
...
pub async fn update_product_count(id: Path<u32>, data: Json<Data>) -> impl Responder {
    ...
    .and_then(|mut query | query.conn.exec_drop(
        query.stmt, 
